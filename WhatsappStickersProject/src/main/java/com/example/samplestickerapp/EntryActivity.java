...
public class EntryActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        AlertDialog.Builder alertPowerSaving = new AlertDialog.Builder(this)
        .setMessage("⚠️Exclude the app from power save settings if you can't see the stickers on WhatsApp⚠️")
        .setCancelable(true)
